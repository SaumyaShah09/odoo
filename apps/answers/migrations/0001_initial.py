    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['question', '-is_accepted', '-vote_score'], name='answers_ans_questio_cdeb1c_idx'), models.Index(fields=['created_by'], name='answers_ans_created_7b5bad_idx')],
            },
        ),
    ]
