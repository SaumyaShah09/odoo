    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_type', models.CharField(choices=[('answer', 'New Answer'), ('comment', 'New Comment'), ('mention', 'Mention'), ('answer_accepted', 'Answer Accepted'), ('vote', 'Vote Received'), ('system', 'System Notification')], max_length=20)),
